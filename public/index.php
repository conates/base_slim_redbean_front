...
//$app->response->headers['Access-Control-Allow-Methods']="POST,OPTIONS";
//$app->response->headers['Access-Control-Allow-Headers']="Content-Type";
...
$app->get('/',function() use ($app,&$config){
    $app->render('../views/front/index.php',array(
        'url' => SITE_URL,
